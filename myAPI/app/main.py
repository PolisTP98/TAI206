...
class UserBase(BaseModel):
    id: int = Field(..., gt = 0, description = "User identifier", example = 1)
    name: str = Field(..., min_length = 3, max_length = 50, description = "User name")
    age: int = Field(..., ge = 0, le = 121, description = "Valid age between 0 and 121")
    aka: str = Field(..., min_length = 3, max_length = 50, description = "User nickname", example = "The GOAT")   
